function example_3D_planning_with_pointcloud_PBVS()
    ...
    Kp_r = 25.0;   % rotational gain
    Kp_t = 25.0;   % translational gain
    ...
    %% --------------------- Lookahead PBVS Loop ---------------------------
    velocityHistory = [];  % Will store each 6x1 twist v over time
    ...
    for iter = 1:maxIter
        ...
        velocityHistory = [velocityHistory, v];  %#ok<AGROW>  % store as columns
